...
class ExampleSubjectTest {
    ...
    void testPlayGameOneRoomMaze() throws InterruptedException {
        ...
        IGameObserver observer = MazeObserver.getNewBuilder(game,"Example Game")
                .useCircleRooms()
    ...
    void testPlayGame4x4RoomMazeWithTwoObservers() throws InterruptedException {
        ExampleSubject game = new ExampleSubject();
        IGameObserver gridLayoutObserver = MazeObserver.getNewBuilder(game,"Example Game")
                .useCircleRooms()
                .useGridLayoutStrategy()
                .setDimension(1200)
                .setRoomDimension(150)
        ...
        IGameObserver radialLayoutObserver = MazeObserver.getNewBuilder(game,"Example Game")
                .useCircleRooms()
